...
public class AppletTest extends BaseTest {
    ...
    public void testMaliciousTripleSign() throws Exception {
        ...
        for(int i = 0; i < 10; ++i) {
            ...
            byte[] recv = pm.msign1(new byte[32], t1s[i].c);
            ...
            recv = pm.msign2(a1, b1, R, ProtocolManager.hash(Util.concat(ProtocolManager.encodeBigInteger(c1hat), R1hat.getEncoded(false))));
            ...
            recv = pm.msign3(c1hat, R1hat, ProtocolManager.hash(Util.concat(ProtocolManager.encodeBigInteger(a1hat), ProtocolManager.encodeBigInteger(b1hat))));
